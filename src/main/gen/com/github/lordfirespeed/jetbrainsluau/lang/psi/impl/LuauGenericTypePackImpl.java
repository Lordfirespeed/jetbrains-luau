...
public class LuauGenericTypePackImpl extends ASTWrapperPsiElement implements LuauGenericTypePack {

  public LuauGenericTypePackImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LuauVisitor visitor) {
    visitor.visitGenericTypePack(this);
  }
