...
public class LuauCharStringImpl extends ASTWrapperPsiElement implements LuauCharString {

  public LuauCharStringImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LuauVisitor visitor) {
    visitor.visitCharString(this);
  }
