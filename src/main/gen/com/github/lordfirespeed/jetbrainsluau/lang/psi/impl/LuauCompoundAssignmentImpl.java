...
public class LuauCompoundAssignmentImpl extends ASTWrapperPsiElement implements LuauCompoundAssignment {

  public LuauCompoundAssignmentImpl(@NotNull ASTNode node) {
    super(node);
  }
