...
public class LuauSingletonTypeImpl extends ASTWrapperPsiElement implements LuauSingletonType {

  public LuauSingletonTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LuauVisitor visitor) {
    visitor.visitSingletonType(this);
  }
