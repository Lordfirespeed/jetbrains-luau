...
public class LuauTypePackImpl extends ASTWrapperPsiElement implements LuauTypePack {

  public LuauTypePackImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LuauVisitor visitor) {
    visitor.visitTypePack(this);
  }
