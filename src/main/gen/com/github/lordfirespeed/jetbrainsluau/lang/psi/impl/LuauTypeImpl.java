...
public class LuauTypeImpl extends ASTWrapperPsiElement implements LuauType {
  ...
  @Override
  @Nullable
  public LuauIntersectionSuffix getIntersectionSuffix() {
    return findChildByClass(LuauIntersectionSuffix.class);
  }
  ...
  @Override
  @Nullable
  public LuauUnionSuffix getUnionSuffix() {
    return findChildByClass(LuauUnionSuffix.class);
  }
