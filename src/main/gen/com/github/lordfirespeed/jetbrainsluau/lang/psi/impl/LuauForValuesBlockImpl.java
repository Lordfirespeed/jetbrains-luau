...
public class LuauForValuesBlockImpl extends ASTWrapperPsiElement implements LuauForValuesBlock {

  public LuauForValuesBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LuauVisitor visitor) {
    visitor.visitForValuesBlock(this);
  }
