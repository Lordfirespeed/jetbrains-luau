...
public class LuauVariadicTypePackImpl extends ASTWrapperPsiElement implements LuauVariadicTypePack {

  public LuauVariadicTypePackImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LuauVisitor visitor) {
    visitor.visitVariadicTypePack(this);
  }
