...
public class LuauAssignmentImpl extends ASTWrapperPsiElement implements LuauAssignment {

  public LuauAssignmentImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public LuauVarList getVarList() {
    return findNotNullChildByClass(LuauVarList.class);
  }
